...
| `variant`        | `variant`         | Button variants. Possible values are `"primary"`, `"secondary"`, `"danger"`, `"ghost-primary"`, `"ghost-secondary"`. Defaults to `"primary"`. | `"danger" \| "ghost-primary" \| "ghost-secondary" \| "primary" \| "secondary"` | `'primary'` |
