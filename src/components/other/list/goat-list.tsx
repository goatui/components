...
export class GoatList {
    ...
    return (
      <Host>
        <div class={{
          ...
          {this.invalidData && GoatList.renderInvalidState()}
  ...
  private renderGroups(groups) {
    return <div class='group-container'>
      {this.enableSearch && <goat-input size='sm' class='search' onGoat:change={(evt) => {
        ...
        <goat-icon type='search' size='sm' slot='end' />
      </goat-input>}
