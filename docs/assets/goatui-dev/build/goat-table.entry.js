import { h, r as registerInstance, f as createEvent, e as Host, g as getElement } from './index-433d423f.js';
...
let Table = class {
  ...
  render() {
    return h(Host, null, h("div", { class: { 'table': true, 'sortable': this.sortable, 'paginate': this.paginate } }, h("div", { class: 'table-scroll-container' }, this.renderHeader(), (this.data.length) ? this.renderBody() : renderEmptyData()), h("div", { class: 'table-footer' }, this.renderPagination())));
  }
