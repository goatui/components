...
const P4Button = class {
  ...
  render() {
    return (h(Host, null, h("button", { class: this.getCssClasses(), onClick: this.onClick, disabled: this.disabled || this.showLoader }, this.showLoader && h("p4-spinner", { class: "icon", size: "1rem" }), h("div", { class: "slot-container", style: { 'visibility': this.showLoader ? 'hidden' : 'visible' } }, this.icon && h("p4-icon", { type: this.icon, size: "1rem" }), h("slot", null)))));
  }
};
