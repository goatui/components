...
const p4CheckboxCss = "*{box-sizing:border-box}::selection{color:var(--color-shades-white);background:var(--color-primary-500)}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);border:0}.center-content{display:flex;align-items:center;justify-content:center}:host{display:inline-block;padding-bottom:var(--space-3, 0.75rem)}.checkbox{position:relative;font-family:var(--font-family-paragraph, \"Roboto\", sans-serif);font-style:normal;font-weight:normal;font-size:var(--font-size-p1, 0.875rem);line-height:var(--line-height-p1, 1.0625rem);letter-spacing:-0.04em;display:flex;align-items:center}.checkbox .native-input{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);border:0}.checkbox .slot-container{padding-left:var(--space-2, 0.5rem)}.checkbox .icon-container{line-height:0}.checkbox .icon-container .checkbox-icon{--color:var(--color-neutral-400, #94a3b8)}.checkbox.checkbox-checked .checkbox-icon{--color:var(--color-primary-500, #1d4ed8)}.checkbox:hover .checkbox-icon{--color:var(--color-primary-100, #bbcaf3)}:host([size=lg]) .checkbox{font-size:var(--font-size-p2, 1rem)}:host([size=md]) .checkbox{font-size:var(--font-size-p1, 0.875rem)}:host([size=sm]) .checkbox{font-size:var(--font-size-caption, 0.75rem)}:host([focused]) .icon-container{border-radius:var(--border-radius, 5px);outline:none;box-shadow:0 0 0 0.25rem rgba(3, 155, 229, 0.25)}:host([disabled]) .checkbox{cursor:not-allowed;color:var(--color-neutral-300, #cbd5e1)}:host([disabled]) .checkbox .checkbox-icon{--color:var(--color-neutral-300, #cbd5e1)}";
