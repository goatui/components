...
const P4Input = class {
  ...
  render() {
    ...
    return (h(Host, { "aria-disabled": this.disabled ? 'true' : null, focused: this.hasFocus }, h("div", { class: {
      ...
      } }, h("div", { class: 'slot-container start' }, h("slot", { name: 'start' })), h("input", { class: 'native-input', name: this.name, "aria-labelledby": labelId, ref: input => this.nativeInput = input, type: this.type, placeholder: this.placeholder, autocomplete: this.autocomplete, value: this.value, tabindex: this.tabindex, required: this.required, onKeyDown: this.keyDownHandler, onInput: this.inputHandler, onBlur: this.blurHandler, onFocus: this.focusHandler, disabled: this.disabled }), h("div", { class: 'slot-container end' }, h("slot", { name: 'end' })), h("div", { class: 'input-actions' }, actions.map((action) => {
