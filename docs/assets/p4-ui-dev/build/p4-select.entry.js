  ...
  renderDropdownList() {
    if (typeof this.data !== 'string') {
      if (this.showLoader) {
        ...
        return h("p4-list", { class: "dropdown-list", ref: (el) => this.listElement = el, data: data, value: this.value, "onP4:item-click": (evt) => {
            this.closeList();
