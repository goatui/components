...
const P4Button = class {
  ...
  render() {
    return (h(Host, { focused: this.hasFocus, variant: this.variant, active: this.isActive, size: this.size, "icon-end": this.iconEnd }, h("button", { class: {
        'button': true,
