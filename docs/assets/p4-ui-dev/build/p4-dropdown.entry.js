...
const P4Dropdown = class {
  ...
  renderDropdownList() {
    if (this.isOpen && typeof this.data !== 'string') {
      return h("p4-list", { class: "dropdown-list", ref: (el) => this.listElement = el, data: this.data, variant: this.listVariant, itemVariant: this.itemVariant, enableSearch: this.enableSearch, "onP4:item-click": (evt) => {
          this.closeList();
