...
const P4Checkbox = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: this.getCssClasses() }, index.h("label", { class: "checkbox-wrapper" }, index.h("span", { class: { 'checkbox': true, 'checkbox-checked': this.value, 'checkbox-disabled': this.disabled } }, index.h("input", { type: "checkbox", class: "checkbox-input", value: this.value + '', onClick: this.onChange, disabled: this.disabled }), index.h("span", { class: "checkbox-inner" })), this.label && index.h("span", null, this.label)))));
  }
};
P4Checkbox.style = p4CheckboxCss;

exports.p4_checkbox = P4Checkbox;
